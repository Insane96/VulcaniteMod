...
public class ModSoundTypes {
    ...
    public static final ForgeSoundType VULCANITE_ORE = new ForgeSoundType(1.0F, 1.0F, ModSoundEvents.VULCANITE_ORE_BREAK, SoundEvents.BLOCK_NETHER_ORE_STEP.delegate, ModSoundEvents.VULCANITE_ORE_PLACE, SoundEvents.BLOCK_NETHER_ORE_HIT.delegate, SoundEvents.BLOCK_NETHER_ORE_FALL.delegate);
